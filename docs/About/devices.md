...
!!! info "近日物欲"
    <s>想搞一个大疆的无人机玩玩。飞天视角终究还是别有洞天。</s>无人机政策越来越紧，感觉买了也不好玩，干脆放弃！

    更新：最近又觉得全景相机（Insta360 X4）+VR眼镜（Meta Quest3）是个无敌的组合。
...
- `2019-202?`：荣耀MagicBook 2019 pro。曾经改造为[NAS 3.0](../Note/NAS/index.md)，稳定运行一年有余。
- `2020-2021`：<s>Apple Mac Mini 2018</s>
- `2021-202?`：DIY主机（佚名学长处购入的三手战损伊拉克成色主机，换了张显卡再用几年，`i5 9600kf`+`RTX3060 12GB`）
- `2021-202?`：Surface Go 1（电子垃圾，朋友送我玩玩；现在变成了galgame专用机！）
...
- `2026-20??`：坚果 N5S Pro Max投影仪（下班了就得在最大的屏幕上看看电影、打开PS5开开车）
...
- `2019-202?`：<s>AKG Y30 有线头戴式耳机（很少用，但还不错。有些漏音。）</s>（太久没用，海绵垫已经风化了，电器件倒是没坏）
...
- `2025-2026`：<s>尼康Z5</s>（相机卖给坏女人了，左手倒右手，zy白赚！） + <s>尼康Z 24-50/4-6.3</s>（镜头已出，素质太差）
- `2025-20??`：尼康Z 50/1.8 S 定焦镜头
- `2025-20??`：尼康Z 24-70/4 S 变焦镜头
- `2025-20??`：腾龙Z 70-300/4.5-6.3 Di III RXD(A047) 变焦镜头
- `2025-20??`：神牛V350 闪光灯
- `2026-20??`：马小路PT14 三脚架
- `2026-20??`：尼康Z5 ii（各种新功能馋死我了）

## NAS

- `2022-2022`：<s>群晖DS220j（入门NAS，但是电子垃圾，太丐了。咸鱼来，咸鱼去。）</s>
- `2025-20??`：铁威马F2-220 NAS

## 米家电器

> 租房之后购入了一些生活电器，不知道选什么就选米家了。啥都有，颜值高，够用！
