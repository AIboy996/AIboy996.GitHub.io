...
- `2019-202?`：荣耀MagicBook 2019 pro。现已改造为[NAS 3.0](../Note/NAS/index.md)，稳定运行一年有余。
...
- `2025-202?`：罗技Pop Keys 表情包版（有专门的表情包键，有点意思）
...
- `2025-20??`：尼康Z5 + <s>尼康Z 24-50/4-6.3</s> 套机（镜头已出，素质太差）
