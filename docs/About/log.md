...
- 2025年11月04日
    - 为所有的PNG图片制作了极致压缩的webp版本（体积减少了大约 1937 MB），并且据我观察webp版本的图片一眼看不出什么差距
    - 通过[mkdocs-cust](https://github.com/AIboy996/mkdocs-cust)插件，自定义了glightbox的显示内容：
        - 对于大多数的PNG图片，现在默认只加载webp版本，只有点击放大之后才会加载原始版本
- 2025年11月03日
    - 发现此前上传的图片存在**EXIF隐私泄漏**的问题，遂重构了整个仓库，抹去了所有图片和视频的EXIF信息
- 2025年08月05日
